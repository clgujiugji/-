...
class FallDetection:
    ...
    def set_camera_resolution(self, cap, width, height):
        ...
        if actual_width != width or actual_height != height:
                print(f"Warning: Camera does not support resolution {width}x{height}. Using {actual_width}x{actual_height} instead.")
    ...
    def detect(self):
        ...
        success, image_w, image_h = self.set_camera_resolution(cap, 2048, 1536)
